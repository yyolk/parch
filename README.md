...
Vendored [Urbanist](https://github.com/coreyhu/Urbanist) (sans Regular + Bold) and [Liberation Serif](https://github.com/liberationfonts/liberation-fonts) are SIL OFL 1.1 — see `src/parch/fonts/`. Urbanist has no serif companion; `face="serif"` stays Liberation Serif.
