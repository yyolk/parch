...
Committed proof: [`artifacts/mvp/nomad-2026.pdf`](artifacts/mvp/nomad-2026.pdf) (2026) and sample PNG previews (annual, projects, quarters, July month, July habits, week, daily, notes). Thesis D comparison (not the default): two half-page project sheets — `projects_two_up` / `paint_projects_two_up`, proof [`artifacts/mvp/exp-projects-d-two-up.png`](artifacts/mvp/exp-projects-d-two-up.png).
