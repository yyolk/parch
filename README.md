...
Vendored [Barlow](https://github.com/jpt/barlow) (sans Regular + Bold) and [Liberation Serif](https://github.com/liberationfonts/liberation-fonts) are SIL OFL 1.1 — see `src/parch/fonts/LICENSE-Barlow` and `src/parch/fonts/LICENSE`.
