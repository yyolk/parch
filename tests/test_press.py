...
def test_press_year_pdf(tmp_path: Path):
    ...
    # cover + annual + projects board + index + 12 leaves + 4 quarters + 12 months + 12 habits + 53 weeks + 365 days + 365 notes
    assert len(reader.pages) == 827
    ...
    assert "project-1" in dests
    assert "project-12" in dests
