...
def test_press_year_pdf(tmp_path: Path):
    ...
    # cover + annual + board + index + 8 leaves + meeting index + 16 dests + tasks index + 8 dests + 4 quarters + 12 months + 12 habits + 53 weeks + 365 days + 365 notes
    assert len(reader.pages) == 849
