...
def test_press_year_pdf(tmp_path: Path):
    ...
    # cover + annual + projects board + index + 9 leaves + 4 quarters + 12 months + 12 habits + 53 weeks + 365 days + 365 notes
    assert len(reader.pages) == 824
    ...
    assert "project-2026-09" in dests
