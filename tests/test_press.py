...
def test_press_year_pdf(tmp_path: Path):
    ...
    # cover + annual + board + index + 8 leaves + meeting index + 8 dests + 4 quarters + 12 months + 12 habits + 53 weeks + 365 days + 365 notes
    assert len(reader.pages) == 832
    ...
    assert "meeting-index-2026-01" in dests
    assert "meeting-2026-01" in dests
    assert "meeting-2026-08" in dests
