...
def test_press_year_pdf(tmp_path: Path):
    ...
    # cover + annual + projects + project-detail + 4 quarters + 12 months + 12 habits + 53 weeks + 365 days + 365 notes
    assert len(reader.pages) == 815
    ...
    assert "project-detail-2026" in dests
