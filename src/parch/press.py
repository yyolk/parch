...
def press(
    ...
    ``Fpdf2Plotter``. Overlay may set optional ``family``; unknown family
    fails at ``catalog.path``. Dual-font files are future work — painters
    already pass ``family=`` and do not change.
    """
