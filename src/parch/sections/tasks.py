...
from parch.components import TaskWeek, TasksIndex, TasksMonthBand, WeeklyTasks
...
class TasksSection:
    """Exploratory Tasks C×F hybrid + F weekly dests. Not in YearPlanner."""
        ...
        return Page(
            ...
            components=(
                WeeklyTasks(
                    ...
                    monday=week.monday,
                    sunday=week.sunday,
                    morning=spec.task_morning,
                    later=spec.task_later,
