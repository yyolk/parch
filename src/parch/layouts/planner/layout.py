...
class PlannerLayout:
    ...
    def _paint_well(self, page: Page, plotter: Plotter, well: Rect) -> None:
        match page.kind:
            ...
            case "projects_index":
                paint_projects_index_focus(plotter, well, _one(page, ProjectsIndex))
            case "project":
                paint_project(plotter, well, _one(page, ProjectPage))
            case "quarter":
...
def _header_meta(page: Page) -> str:
    match page.kind:
        ...
        case "project":
            return str(_one(page, ProjectPage).year)
        case "quarter":
            return ""
        case "month":
...
def _header_chip_dest(page: Page) -> str | None:
    match page.kind:
        ...
        case "project":
            return _one(page, ProjectPage).index_dest
        case _:
            return None
