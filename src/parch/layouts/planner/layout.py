    ...
    def _paint_well(self, page: Page, plotter: Plotter, well: Rect) -> None:
        match page.kind:
            ...
            case "projects_index_checklist":
                paint_projects_index_checklist(plotter, well, _one(page, ProjectsIndexChecklist))
            case "project":
                paint_projects(plotter, well, _one(page, ProjectsBoard))
            case "quarter":
...
def _header_meta(page: Page) -> str:
    match page.kind:
        ...
        case "projects_index_checklist":
            return str(_one(page, ProjectsIndexChecklist).year)
        case "project":
            return _one(page, ProjectLeaf).page
        case "quarter":
            return ""
        case "month":
