...
class PlannerLayout:
    ...
    def _paint_well(self, page: Page, plotter: Plotter, well: Rect) -> None:
        match page.kind:
            ...
            case "projects_index":
                paint_projects_index_grid(plotter, well, _one(page, ProjectsIndex))
            case "project":
                paint_project_sheet(plotter, well, _one(page, ProjectSheet))
            case "quarter":
...
def _header_meta(page: Page) -> str:
    match page.kind:
        ...
        case "project":
            return f"{_one(page, ProjectSheet).number:02d}"
        case "quarter":
            return ""
        case "month":
...
def _header_chip_dest(page: Page) -> str | None:
    match page.kind:
        ...
        case "project":
            return _one(page, ProjectSheet).index_dest
        case _:
            return None
