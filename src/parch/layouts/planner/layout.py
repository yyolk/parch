...
class PlannerLayout:
    ...
    cover / header paint (``ramp.ink``). Other painters may keep face+bold;
    ``Fpdf2Plotter`` resolves that path through the same ramp's FaceBridge
    (``ramp.resolve_face``). Dual-font ramps are future work; ``family``
    stays on the ink.
    """
