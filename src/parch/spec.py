...
class Spec:
    ...
    def __post_init__(self) -> None:
        ...
        if not 6 <= self.meeting_index_rows <= 8:
            raise ConfigError("meeting_index_rows must be 6–8")
    ...
    def from_mapping(cls, data: TomlTable) -> Spec:
        ...
        return cls(
            ...
            meeting_index_rows=int(
                meetings_table.get("index_rows", data.get("meeting_index_rows", 7))
            ),
        )
