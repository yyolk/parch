...
class Spec:
    ...
    def __post_init__(self) -> None:
        ...
        if not 8 <= self.project_index_rows <= 12:
            raise ConfigError("project_index_rows must be 8–12")
    ...
    def from_mapping(cls, data: TomlTable) -> Spec:
        ...
        return cls(
            ...
            project_index_rows=int(
                projects_table.get("index_rows", data.get("project_index_rows", 10))
            ),
        )
