...
from parch.fonts.ramp import JOST_FAMILY_OVERLAY, TypeOverlay
...
# Device-owned family layer — Nomad names Jost explicitly so a later
# dual-font catalog can swap family= without painter changes. Size/weight
# stay unset (thesis M owns those knobs). Specimens still look Jost.
NOMAD_TYPE_OVERLAY = JOST_FAMILY_OVERLAY
