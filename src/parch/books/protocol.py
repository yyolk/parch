...
# full-bleed dot-grid extras, rapid-log, and monthly-task kinds omitted.
...
def plot_pages(
    ...
    *,
    ...
    Cover, weekly, daily, notes, leaves, habits, pad, dot-grid extras,
    rapid-log, and monthly-task kinds are omitted — pads with only those
    kinds get an empty outline.
    """
    ledger = list(pages())
