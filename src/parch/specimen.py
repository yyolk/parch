...
# Engineering notebook — cover + duplex pad faces (not YearPlanner dests).
...
def write_specimens(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        for page, stem in enumerate(ENGINEERING_STEMS, start=1):
            render_page_png(notebook_pdf, page, dest / f"{stem}.png")
