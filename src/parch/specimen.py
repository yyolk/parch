...
# Notebook cover + duplex pad faces — pressed from EngineeringNotebook.
ENGINEERING_STEMS = (
    "engineering-notebook-cover",
    "engineering-front",
    "engineering-back",
)
...
def write_specimens(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        press(notebook, nb_pdf, proof=True)
        render_page_png(nb_pdf, 1, dest / "engineering-notebook-cover.png")
