"""Single fpdf2-backed plotter. Martian Grotesk + Liberation Serif, fake small-caps."""
...
class Fpdf2Plotter(Plotter):
    def __init__(self, device: Device) -> None:
        ...
        root = font_dir()
        grotesk = root / "martian-grotesk"
        self.pdf.add_font(SANS, "", str(grotesk / "MartianGrotesk-Regular.ttf"))
        self.pdf.add_font(SANS, "B", str(grotesk / "MartianGrotesk-Bold.ttf"))
