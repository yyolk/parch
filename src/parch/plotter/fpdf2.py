"""Single fpdf2-backed plotter. Barlow sans + Liberation Serif, fake small-caps."""
...
class Fpdf2Plotter(Plotter):
    def __init__(self, device: Device) -> None:
        ...
        root = font_dir()
        self.pdf.add_font(SANS, "", str(root / "Barlow-Regular.ttf"))
        self.pdf.add_font(SANS, "B", str(root / "Barlow-Bold.ttf"))
